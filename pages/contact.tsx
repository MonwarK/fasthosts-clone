...
export default function contact() {
  return (
    <div className='flex-1 min-h-[80vh] dark:bg-gray-900'>
      <div className='text-[#031A4A] dark:text-white font-medium max-w-4xl mx-auto px-8 py-10'>
        <Head>
          <title>Contact us | Fasthosts</title>
        </Head>
        <h1 className='text-5xl md:text-7xl font-semibold text-blue-500 dark:text-white'>Contact us</h1>
        ...
        <div className='grid md:grid-cols-2 gap-3'>
          <div className='space-y-5'>
            <div>
              ...
              <div className='text-gray-500 dark:text-gray-100 font-medium text-sm'>
